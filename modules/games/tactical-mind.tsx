...
export default function TacticalMind() {
	useEffect(() => {
		console.log('Tactical Mind initialized')
		return () => console.log('Tactical Mind destroyed')
	}, [])
	...
	return (
		<div className='flex flex-col items-center justify-center min-h-[400px] border-2 border-dashed border-primary/20 rounded-[32px] bg-secondary/5'>
			<h2 className='text-3xl font-black italic uppercase'>Tactical Mind</h2>
